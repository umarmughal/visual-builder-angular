...
exports.REPLACE_NEXT_LINE = (filepath, after, replace, parser = 'babel') => {
...
exports.REPLACE_BETWEEN = (filepath, after, before, replace, parser = 'babel') => {
  const resolvedPath = getResolvedPath(filepath)
  const isExist = getIsExist(resolvedPath)
  if (!isExist) {
    return
...
exports.WRITE_FILE = (folderpath, subfolder, filename, content, parser = 'babel') => {
  const resolvedFolderPath = getResolvedPath(folderpath)
